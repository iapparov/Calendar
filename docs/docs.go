            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.EventRequestCreate"
                        }
                    }
                ],
                "responses": {
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.EventRequestDelete"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "string",
                        "example": "\"2026-02-01\"",
                        "description": "Начало месяца в формате YYYY-MM-DD",
                        "name": "date",
                        "in": "query",
                        "required": true
                    }
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "string",
                        "example": "\"2026-02-23\"",
                        "description": "Начало недели в формате YYYY-MM-DD",
                        "name": "date",
                        "in": "query",
                        "required": true
                    }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.EventRequestUpdate"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "dto.EventRequestCreate": {
            ...
            "properties": {
                ...
                "event": {
                    "type": "string",
                    "example": "Обсуждение планов на квартал"
                },
                "event_name": {
                    "type": "string",
