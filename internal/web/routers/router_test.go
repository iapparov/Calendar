...
func (m *mockRouterAuthService) Login(login, password string, ctx context.Context) (*jwt.AuthTokens, error) {
	return &jwt.AuthTokens{AccessToken: "test-token", RefreshToken: "refresh-token"}, nil
}

func (m *mockRouterAuthService) Register(login, password, email, telegram string, ctx context.Context) (*user.User, error) {
...
func TestRegisterRoutes_EventEndpoints_WithAuth(t *testing.T) {
	...
	t.Run("POST /api/v1/event/create_event", func(t *testing.T) {
		body := `{"event_name":"Test Event","date":"2026-03-15","event":"Description","reminder_time":"2026-03-14"}`
		req, _ := http.NewRequest("POST", "/api/v1/event/create_event", bytes.NewBufferString(body))
		req.Header.Set("Content-Type", "application/json")
	...
	t.Run("GET /api/v1/event/events_for_day", func(t *testing.T) {
		req, _ := http.NewRequest("GET", "/api/v1/event/events_for_day?date=2026-03-15", nil)
		req.Header.Set("Authorization", "Bearer valid-token")
	...
	t.Run("GET /api/v1/event/events_for_week", func(t *testing.T) {
		req, _ := http.NewRequest("GET", "/api/v1/event/events_for_week?date=2026-03-15", nil)
		req.Header.Set("Authorization", "Bearer valid-token")
	...
	t.Run("GET /api/v1/event/events_for_month", func(t *testing.T) {
		req, _ := http.NewRequest("GET", "/api/v1/event/events_for_month?date=2026-03-15", nil)
		req.Header.Set("Authorization", "Bearer valid-token")
...
func TestRegisterRoutes_EventEndpoints_WithoutAuth(t *testing.T) {
	...
	t.Run("POST /api/v1/event/create_event without auth", func(t *testing.T) {
		body := `{"event_name":"Test Event","date":"2026-03-15","event":"Description","reminder_time":"2026-03-14"}`
		req, _ := http.NewRequest("POST", "/api/v1/event/create_event", bytes.NewBufferString(body))
		req.Header.Set("Content-Type", "application/json")
...
func TestRegisterRoutes_UpdateEvent(t *testing.T) {
	...
	t.Run("PUT /api/v1/event/update_event", func(t *testing.T) {
		...
		req, _ := http.NewRequest("PUT", "/api/v1/event/update_event", bytes.NewBufferString(body))
		req.Header.Set("Content-Type", "application/json")
		req.Header.Set("Authorization", "Bearer valid-token")
...
func TestRegisterRoutes_DeleteEvent(t *testing.T) {
	...
	t.Run("DELETE /api/v1/event/delete_event", func(t *testing.T) {
		body := `{"event_id":"` + uuid.New().String() + `"}`
		req, _ := http.NewRequest("DELETE", "/api/v1/event/delete_event", bytes.NewBufferString(body))
		req.Header.Set("Content-Type", "application/json")
		req.Header.Set("Authorization", "Bearer valid-token")
